  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F3E8D9]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-24 right-[-60px] h-64 w-64 rounded-full bg-[#D9B15F]/30 blur-3xl" />
        <div className="absolute bottom-[-80px] -left-20 h-72 w-72 rounded-full bg-[#4F46E5]/20 blur-3xl" />
        <div className="absolute bottom-[-100px] left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-[#D9B15F]/22 blur-3xl" />
